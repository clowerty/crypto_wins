...
<body>
	...
	<header class="header-section clearfix">
		<div class="container-fluid">
			...
			<a href="/girisyap" class="site-btn"id="active"  style="color:#7ad4cc">Giriş Yap</a>
			<a href="/kayitol" class="site-btn"   style="color:#7ad4cc">Kayıt Ol</a>
			<nav class="main-menu">
				<ul class="menu-list">
                        <li><a href="/anket"  style="color:#7ad4cc">Anket</a></li>
					<li><a href="#"  style="color:#7ad4cc">Piyasalar</a></li>
					<li><a href="#"  style="color:#7ad4cc">Hakkımızda</a></li>
					<li><a href="#"  style="color:#7ad4cc">SSS</a></li>
					<li><a href="https://view.forms.app/nerimantopcu/iletisim"target="_blank" style="color:#7ad4cc">İletişim</a></li>
				</ul>
			</nav>
		</div>
	</header>
